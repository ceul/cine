  ...
  <head>
    ...
    <script type="text/javascript">
      function elimina(id){
			$.ajax({
			    type: "POST",
			    url: "controllers/ePelicula.php",
			    data: "id="+id,
			    success: function(html){
			    if(html=='1'){
			    	bootbox.alert("Fue eliminado correctamente", function() {
                		document.location="iPelicula.php";
                	        });
			    }
			    else{
...
alert("  ->"+html+" res");
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="codigo" placeholder="Código de la Pelicula" required />
    </div>
  </div>
  <div class="form-group">
