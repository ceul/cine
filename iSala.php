		...
		$("#ingresar").click(function(){ 
			...
			tamano=$("#tamano").val();
			 ...
			 $.ajax({
			    ...
			    data: "codigo="+codigo+"&cantidad="+cantidad+"&tipo="+tipo+"&tamano="+tamano,
			    success: function(html){ 
alert("  ->"+html+" res");
			    if(html=='1'){
  ...
  <div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">Nro Sala</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="codigo" placeholder="Código del estado" required />
    </div>
  </div>
  <div class="form-group">
    <label for="inputPassword3" class="col-sm-2 control-label">Cantidad de sillas</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="cantidad" placeholder="Nombre del estado" required />
    </div>
  </div>
  <div class="form-group">
    <label for="inputPassword3" class="col-sm-2 control-label">Tipo de sala</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="tipo" placeholder="Descripcion del estado" required />
    </div>
  </div>
  <div class="form-group">
    <label for="inputPassword3" class="col-sm-2 control-label">Tamaño</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="tamano" placeholder="Descripcion del estado" required />
    </div>
  </div>
  <div class="form-group">
